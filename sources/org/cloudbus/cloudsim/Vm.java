...
public class Vm {
	...
	public double getTotalUtilizationOfRamMb(double time) {
		return getTotalUtilizationOfRam(time) * getRam();
	}

	public double getTotalUtilizationOfBwMbs(double time) {
		return getTotalUtilizationOfBw(time) * getBw();
	}
	/**
	 * Sets the uid.
	 * 
